...
\emph{Inverse reinforcement learning} (IRL) \cite{ng2000algorithms} addresses the problem of learning reward functions for decision making tasks from human demonstration. IRL methods are useful in tasks for which the desired behaviour can be easily demonstrated but an appropriate reward function is hard to formalise \emph{a priori}. The learned reward function aims to capture the preferences and goals of the human demonstrator and can be used to induce control policies that imitate the demonstrated behaviour. Learning a reward function, as opposed to directly learning a control policy, also makes it easier to generalise the desired behaviour to other similar domains.
