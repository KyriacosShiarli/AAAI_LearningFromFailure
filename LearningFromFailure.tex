...
A another way of penalising similarity to the failed demonstrations can be formulated by removing the extra constraint in \eqref{eq:abs_inequality} and instead adding to the objective the inner product of a parameter vector $\theta=\left[\theta_1~\ldots~\theta_k\right]^T$ and the difference in feature expectations, yielding the following objective function:
	\begin{equation}
		\max\limits_{\pi,\theta} H(\mathcal{A}^h||\mathcal{S}^h) + \sum^K_{k=1} \theta_k (\mu^{\pi}_k|_{\mathcal{F}} - \widetilde{\mu}^{\mathcal{F}}_k). \label{eq:penalise}
	\end{equation}
...
\begin{figure*}[t]
  ...
  \begin{subfigure}[t]{0.57\columnwidth}
    \includegraphics[clip=true,width=1.0\textwidth]{images/expert_apprentice_contrastive.eps}
    \caption{Contrasting w.r.t.\ $w^{\mathcal{D}^*}$}
    \label{fig:toy_expert_apprentice_contrastive}
   \end{subfigure}
   \hspace{19mm}
   \begin{subfigure}[t]{0.57\columnwidth}
    \includegraphics[trim=0.6cm 0.0cm 0.0cm 0.0cm,clip=true,width=0.93\textwidth]{images/over_expert_apprentice.eps}
    \caption{Overlapping w.r.t.\ $w^{\mathcal{D}^*}$}
    \label{fig:toy_expert_apprentice_overlapping}
    \end{subfigure}
    \hspace{13mm}
    \begin{subfigure}[t]{0.57\columnwidth}
    \includegraphics[trim=0.6cm 0.0cm 0.0cm 0.0cm,clip=true,width=0.95\textwidth]{images/expert_apprentice_complementary.eps}
    ...
    \hspace{-2mm}
  \begin{subfigure}[t]{0.57\columnwidth}
    \includegraphics[clip=true,width=1.0\textwidth]{images/taboo_apprentice_contrastive.eps}
    \caption{Contrasting w.r.t. $w^{\mathcal{F}^*}$}
    \label{fig:toy_taboo_apprentice_contrastive}
   \end{subfigure}
   \hspace{19mm}
   \begin{subfigure}[t]{0.57\columnwidth}
    \includegraphics[trim=0.6cm 0.0cm 0.0cm 0.0cm,clip=true,width=0.93\textwidth]{images/over_taboo_apprentice.eps}
    \caption{Overlapping w.r.t.\ $w^{\mathcal{F}^*}$}
    \label{fig:toy_taboo_apprentice_overlapping}
    \end{subfigure}
    \hspace{13mm}
    \begin{subfigure}[t]{0.57\columnwidth}
    \includegraphics[trim=0.6cm 0.0cm 0.0cm 0.0cm,clip=true,width=0.95\textwidth]{images/taboo_apprentice_complementary.eps}
...
\begin{figure}
	\vspace{-5mm}
	\centering
 	\includegraphics[clip=true,width=0.4\textwidth]{images/data_size.eps}
...
%	\hspace{-5cm}
    ...
    \includegraphics[clip=true,width=1.25\textwidth]{images/factory_1.eps}
 ...
 \hspace{5mm}
  \begin{subfigure}[b]{0.455\columnwidth}
    \includegraphics[trim=0.8cm 0.0cm 0.0cm 0.0cm,clip=true,width=1.20\textwidth]{images/factory_2.eps}
...
%  \vspace{-2mm}
  \centering
    \includegraphics[width=0.77\columnwidth]{images/data_plot.png}
...
%  hspace{-16pt}
    ...
    \includegraphics[scale = 0.23]{images/gp.eps}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\columnwidth}
    \includegraphics[scale = 0.23]{images/bp.eps}
  	\end{subfigure}
...
\begin{figure}[h!]
	\centering
	\begin{subfigure}[b]{0.49\columnwidth}
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=1.1\textwidth]{images/expert_apprentice_real.eps}
    \caption{Value w.r.t.\ $w^{\mathcal{D}^*}$}
    \end{subfigure}
    %\hspace{mm}
    \begin{subfigure}[b]{0.49\columnwidth}
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=1.1\textwidth]{images/taboo_apprentice_real.eps}
    \caption{Value w.r.t.\ $w^{\mathcal{F}^*}$}
  	\end{subfigure}
