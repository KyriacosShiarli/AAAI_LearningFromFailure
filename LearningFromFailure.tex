...
\end{subfigure}
\vspace{-4mm}
  \caption{\small{Sample trajectories from $R^\mathcal{D}$ (left) and $R^\mathcal{F}$ (right). Darker dots occur later in time.}} %These reward functions were learned from real data. The alpha channel denotes time}}
  \label{fig:paths}
\vspace{-4mm}
\end{figure}
