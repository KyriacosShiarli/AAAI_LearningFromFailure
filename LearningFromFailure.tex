...
\begin{figure*}[t]
  ...
  \begin{subfigure}[t]{0.55\columnwidth}
   ...
   \hspace{15mm}
   \begin{subfigure}[t]{0.55\columnwidth}
    \includegraphics[trim=0.6cm 0.0cm 0.0cm 0.0cm,clip=true,width=1.45\textwidth]{images/expert_apprentice_contrastive.pdf}
  ...
  \begin{subfigure}[t]{0.55\columnwidth}
   ...
   \hspace{15mm}
   \begin{subfigure}[t]{0.55\columnwidth}
    \includegraphics[trim=0.6cm 0.0cm 0.0cm 0.0cm,clip=true,width=1.45\textwidth]{images/taboo_apprentice_contrastive.pdf}
