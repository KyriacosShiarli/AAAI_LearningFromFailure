...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.45\columnwidth}
    \includegraphics[clip=true,width=\textwidth]{images/expert_apprentice_contrastive.pdf}
  ...
  \hfill
  \begin{subfigure}[b]{0.45\columnwidth}
    \includegraphics[clip=true,width=\textwidth]{images/taboo_apprentice_contrastive.pdf}
  ...
  \begin{subfigure}[b]{0.45\columnwidth}
    \includegraphics[clip=true,width=\textwidth]{images/expert_apprentice_complementary.pdf}
    \caption{Complementary w.r.t.\ $w^{\mathcal{D}^*}$}
    \label{fig:toy_expert_apprentice_complementary}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.45\columnwidth}
    \includegraphics[clip=true,width=\textwidth]{images/taboo_apprentice_complementary.pdf}
...
\aama{We also evaluate the performance of IRLF on a social navigation dataset gathered using a real robot. This dataset consists of 47 trajectories of an expert navigating the robot towards the an interaction target while avoiding a moving or standing  person in a socially appropriate way. The positions of the people and the robot were accurately recorded using a motion capture system covering an area of 5m x 5m. A sample of the collected trajectories can be observed in Figure {ref}. For safety reasons the failed dataset $\mathcal{F}$, which consists of $59$ trajectories, was collected by driving the robot in a simulator in a way that intentionally violates social norms, e.g., running into, following, or standing next to people. }
