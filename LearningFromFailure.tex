...
\alignauthor
Kyriacos Shiarlis\\
       \affaddr{Institute Of Informatics, University of Amsterdam}\\
...
\alignauthor
Shimon Whiteson\\
       \affaddr{Department of Computer Science, University of Oxford}\\
...
\begin{figure}[t]     
  \centering
    \includegraphics[width=1.05\columnwidth]{images/data_plot.png}
...
%  \hspace{-16pt}
	\centering
    \includegraphics[scale = 0.3]{images/gp.pdf}
    \includegraphics[scale = 0.3]{images/bp.pdf}
...
%	\hspace{-5mm}
	\centering
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=0.35\textwidth]{images/expert_apprentice_real.pdf}
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=0.35\textwidth]{images/taboo_apprentice_real.pdf}
