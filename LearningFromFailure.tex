...
Armed with a clear motivation, and the derivation above, we now proceed to investigate the performance of the IRLF algorithm in a toy domain and real data related to social robotic navigation. 
The task of designing navigation cost functions that allow a robot to navigate apprpriately in a social environment is a challenging task, mainly because the social rules that underly it are
