...
Figure \ref{fig:toy_expert_apprentice_contrastive} demonstrates the performance of IRLF (blue,green) and Maximum Causal Entropy IRL (red), on the constrastive scenario when evaluated on $w^{\mathcal{D}^*}$. We can see that our algorithms
...
\begin{figure*}[t]
  ...
  \begin{subfigure}[b]{0.475\columnwidth}
    \includegraphics[trim=0.5cm 1cm 0.5cm 0,clip=true,width=\textwidth]{images/expert_apprentice_contrastive.pdf}
