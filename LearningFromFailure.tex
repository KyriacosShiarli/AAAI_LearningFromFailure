...
%	\hspace{-5mm}
	\centering
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=0.34\textwidth]{images/expert_apprentice_real.pdf}
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=0.34\textwidth]{images/taboo_apprentice_real.pdf}
