...
\begin{figure}
	\vspace{-5mm}
	\centering
 	\includegraphics[clip=true,width=0.4\textwidth]{images/data_size.pdf}
...
%  hspace{-16pt}
    ...
    \includegraphics[scale = 0.23]{images/gp.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\columnwidth}
    \includegraphics[scale = 0.23]{images/bp.pdf}
  	\end{subfigure}
...
\begin{figure}[h!]
	...
	\centering
	\begin{subfigure}[b]{0.49\columnwidth}
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=1.1\textwidth]{images/expert_apprentice_real.pdf}
    \caption{Value w.r.t.\ $w^{\mathcal{D}^*}$}
    \end{subfigure}
    %\hspace{mm}
    \begin{subfigure}[b]{0.49\columnwidth}
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=1.1\textwidth]{images/taboo_apprentice_real.pdf}
    \caption{Value w.r.t.\ $w^{\mathcal{F}^*}$}
  	\end{subfigure}
