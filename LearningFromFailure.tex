...
Algorithm \ref{alg:lff} describes IRLF procedurely. First we compute the empirical feature expectations lines(1-2) for both datasets $\mathcal{D},\mathcal{F}$ using \eqref{eqn:empirical_fe}.	The initial state distributions are also computed (lines 1-4) by taking the normalised counts of the initial states in the two datasets. Lines 5 - 8 initialise the reward function that is used to find a policy in line 9. Using this policy the model feature expectations can be calculated using the procedure described in \cite{ziebart2013principle}. Lines 12 and 13 peform the updates described by \eqref{eq:update_success} and \eqref{eq:update_failure2} respectively. Finally lines 14 and 15 peform the incremental reduction of the parameter $\lambda$
...
\begin{figure*}[t]
  ...
  \begin{subfigure}[b]{0.475\columnwidth}
    \includegraphics[trim=0.1cm 0.3cm 0.2cm 0.2,clip=true,width=\textwidth]{images/expert_apprentice_contrastive.pdf}
  ...
  \hfill
  \begin{subfigure}[b]{0.475\columnwidth}
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=\textwidth]{images/taboo_apprentice_contrastive.pdf}
  ...
  \begin{subfigure}[b]{0.475\columnwidth}
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=\textwidth]{images/expert_apprentice_complementary.pdf}
  ...
  \hfill
  \begin{subfigure}[b]{0.475\columnwidth}
    \includegraphics[trim=0.5cm 0.5cm 0.2cm 0.2,clip=true,width=\textwidth]{images/taboo_apprentice_complementary.pdf}
