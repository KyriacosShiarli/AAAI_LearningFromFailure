...
\begin{figure*}[t]
  ...
  \begin{subfigure}[b]{0.475\columnwidth}
    \includegraphics[trim=0.5cm 1cm 0.5cm 0,clip=true,width=\textwidth]{images/expert_apprentice_contrastive.eps}
  ...
  \hfill
  \begin{subfigure}[b]{0.475\columnwidth}
    \includegraphics[trim=0.5cm 0.5cm 0.5cm 0,clip=true,width=\textwidth]{images/taboo_apprentice_contrastive.eps}
